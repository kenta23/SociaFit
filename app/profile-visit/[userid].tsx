...
export default function ProfileVisit() {
	...
	useEffect(() => {
		const getUser = async () => {
			...
			const { userData, following, likes, activities } = await getUserData(
				userid as string,
			);
