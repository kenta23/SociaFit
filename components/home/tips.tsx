				...
				>
					<View style={styles.item}>
						<Image
							...
							contentFit="cover"
							source={require("@/assets/tip 1.png")}
						/>
						<Text style={[styles.theImportanceOf, styles.tooBusyToTypo]}>
							The Importance of a Bench Press Arch
						</Text>
						<Image
							style={[styles.akarIconsarrowUp, styles.tooBusyToPosition]}
							contentFit="cover"
							source={require("@/assets/arrow-up.svg")}
						/>
						<View style={styles.frameGroup}>
							<View style={[styles.chestWorkoutWrapper, styles.wrapperLayout]}>
								<Text style={[styles.chestWorkout, styles.proPosition]}>
									Chest workout
								</Text>
							</View>
							<View style={[styles.beginnerWrapper, styles.wrapperLayout]}>
								<Text style={[styles.beginner, styles.proPosition]}>
									Beginner
								</Text>
							</View>
				...
				>
					<View style={styles.item}>
						<Image
							style={styles.backgroundImage}
							contentFit="cover"
							source={require("@/assets/tip 2.png")}
						/>
						<Text style={[styles.tooBusyTo, styles.tooBusyToPosition]}>
							Too Busy to Work Out? Try ThisWeekend-Only Workout Plan.
						</Text>
						<Image
							style={[styles.akarIconsarrowUp, styles.tooBusyToPosition]}
							contentFit="cover"
						...
						<View style={styles.frameGroup}>
							...
							<View style={[styles.beginnerWrapper, styles.wrapperLayout]}>
								<Text style={[styles.fitness, styles.fitnessPosition]}>
									Fitness
								</Text>
							</View>
						</View>
				...
				>
					<View style={styles.item}>
						<Image
							style={styles.backgroundImage}
							contentFit="cover"
							source={require("@/assets/tip 3.png")}
						/>
						<Text style={[styles.tooBusyTo, styles.tooBusyToPosition]}>
						...
						<View style={styles.frameGroup}>
							...
							<View style={[styles.fitnessContainer, styles.wrapperLayout]}>
								<Text style={[styles.fitness1, styles.fitnessPosition]}>
									Fitness
								</Text>
							</View>
						</View>
